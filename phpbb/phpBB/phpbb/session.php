...
class session {
	 ...
	 *
	 * @param bool    $update_session_page (optional) if true the session page gets updated.
	 * @return unknown
	 */
	 ...
	 * @param unknown $set_admin     (optional)
	 * @param unknown $persist_login (optional)
	 * @param unknown $viewonline    (optional)
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $new_session (optional)
	 * @return unknown
	 */
	 ...
	 * @param bool    $httponly   (optional) Use HttpOnly. Defaults to true. Use false to make cookie accessible by client-side scripts.
	 */
	 ...
	 * @param mixed        $user_ips   (optional) Can contain a string with one IP or an array of multiple IPs
	 * @param string|false $user_email The user email
	 * @param bool         $return     (optional) If $return is false this routine does not return on finding a banned user,
	 * @return unknown
	 */
	 ...
	 * @param unknown $user_ip (optional)
	 * @return unknown
	 */
	 ...
	 * @param string  $session_id   (optional) optional session_id, defaults to current user's session_id
	 */
