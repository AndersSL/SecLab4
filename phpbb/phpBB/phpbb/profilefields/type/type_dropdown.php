...
class type_dropdown extends type_base
{
	 ...
	 * {@inheritDoc}
	 *
	 * @param unknown $default_lang_id
	 * @param unknown $field_data
	 * @return unknown
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * @param unknown $field_value (reference)
	 * @param unknown $field_data
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $profile_row
	 * @param unknown $preview_options (optional)
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * @param unknown $exclude_options    (reference)
	 * @param unknown $visibility_options (reference)
	 * @return unknown
	 */
	 ...
	 * @param unknown $field_data    (reference)
	 * @param unknown $step
	 * @return unknown
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * @param unknown $template_vars (reference)
	 * @param unknown $field_data    (reference)
	 */
