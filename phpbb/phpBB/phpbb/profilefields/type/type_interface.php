...
interface type_interface
{
	 ...
	 *
	 * @param mixed   $field_value (reference) Field value to validate
	 ...
	 *
	 * @param array   $profile_row     Array with data for this field
	 * @param mixed   $preview_options (optional) When previewing we use different data
	 * @return null
	 */
	 ...
	 *
	 * @param array   $exclude_options    (reference) Array with options that should be excluded in the steps
	 * @param array   $visibility_options (reference) Array with options responsible for the fields visibility
	 ...
	 * @param array   $field_data    (reference) Array with data for this field
	 ...
	 *
	 * @param array   $template_vars (reference) Template variables we are going to assign
	 * @param array   $field_data    (reference) Array with data for this field
	 * @return null
	 */
