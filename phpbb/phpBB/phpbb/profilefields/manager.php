...
class manager {
	 ...
	 * @param string  $mode     The mode (profile|register)
	 * @param int     $lang_id  The language identifier
	 * @param array   $cp_data  (reference) Custom profile field data
	 * @param array   $cp_error (reference) Custom profile field errors
	 */
	 ...
	 *
	 * @param string  $restrict_option (optional) Restrict the published fields to a certain profile field option
	 ...
	 * @param bool    $use_contact_fields (optional) Should we display contact fields as such?
	 ...
	 *
	 * @param string  $type_name Type identifier of the profile fields
	 * @param bool    $active    (optional) True to limit output to active profile fields, false for all
