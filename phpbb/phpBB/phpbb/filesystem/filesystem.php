...
class filesystem implements filesystem_interface
{
	 ...
	 *
	 * @param unknown $files
	 * @param unknown $perms            (optional)
	 * @param unknown $recursive        (optional)
	 * @param unknown $force_chmod_link (optional)
	 */
	 ...
	 * {@inheritdoc}
	 *
	 * @param unknown $origin_file
	 * @param unknown $target_file
	 * @param unknown $override    (optional)
	 */
	 ...
	 * {@inheritdoc}
	 *
	 * @param unknown $end_path
	 * @param unknown $start_path
	 * @return unknown
	 */
	 ...
	 * @param unknown $origin_dir
	 * @param unknown $target_dir
	 * @param unknown $copy_on_windows (optional)
	 */
	 ...
	 * @param unknown $access_time (optional)
	 */
	 ...
	 * @param string  $prefix       (optional) The path prefix (on windows the drive letter)
	 * @param bool    $absolute     (optional) Whether or not the path is absolute
	 * @param bool    $return_array (optional) Whether or not to return path parts
