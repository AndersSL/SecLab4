...
class teampage implements \phpbb\groupposition\groupposition_interface
{
	 ...
	 * @param bool    $skip_group (optional) Skip setting the value for this group, to save the query, when you need to update it anyway.
	 ...
	 * @param bool    $skip_group  (optional) Skip setting the group to GROUP_DISABLED, to save the query, when you need to update it anyway.
