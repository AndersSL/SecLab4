...
class manager {
	 ...
	 * @param bool    $load_enabled (optional) Load only enabled avatars
	 ...
	 * @param string  $prefix (optional) Prefix of data keys (e.g. user), should not include the trailing underscore
