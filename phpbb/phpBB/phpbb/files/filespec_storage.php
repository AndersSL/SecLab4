...
class filespec_storage {
	 ...
	 *
	 * @param string  $mode    (optional) Either real, unique, or unique_ext. Real creates a
	 * @param string  $prefix  (optional) Prefix applied to filename
	 * @param string  $user_id (optional) The user_id is only needed for when cleaning a user's avatar
	 */
	 ...
	 * @param bool                   $overwrite        (optional) If set to true, an already existing file will be overwritten
	 * @param bool                   $skip_image_check (optional) If set to true, the check for the file to be a valid image is skipped
