...
class path_helper {
	 ...
	 * @param mixed                            $adm_relative_path (optional) Relative path admin path to adm/ root
	 */
	 ...
	 * @param bool    $is_amp (optional) Is the parameter separator &amp;. Defaults to true.
	 ...
	 * @param bool    $mod_rewrite (optional) Whether mod_rewrite is enabled, default: false
