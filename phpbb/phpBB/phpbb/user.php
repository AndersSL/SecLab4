...
class user extends \phpbb\session
{
	 ...
	 *
	 * @param unknown $lang_set (optional)
	 * @param unknown $style_id (optional)
	 */
	 ...
	 *
	 * @deprecated: 3.2.0-dev (To be removed: 4.0.0)
	 * @param unknown $number     int|float   The number we want to get the plural case for. Float numbers are floored.
	 * @param unknown $force_rule (optional) mixed   False to use the plural rule of the language package
	 ...
	 * @param bool    $use_db   (optional) internal variable for recursion, do not use @deprecated 3.2.0-dev (To be removed: 4.0.0)
	 * @param bool    $use_help (optional) internal variable for recursion, do not use @deprecated 3.2.0-dev (To be removed: 4.0.0)
	 * @param string  $ext_name (optional) The extension to load language from, or empty for core files
	 */
	 ...
	 *
	 * @deprecated 3.2.0-dev (To be removed: 4.0.0)
	 * @param unknown $lang_set
	 * @param unknown $use_help
	 * @param unknown $ext_name
	 */
	 ...
	 * @param mixed   $lang_set specifies the language entries to include
	 * @param bool    $use_db   (optional) internal variable for recursion, do not use
	 * @param bool    $use_help (optional) internal variable for recursion, do not use
	 */
	 ...
	 * @param string  $format    (optional) date format in date() notation. | used to indicate relative dates, for example |d m Y|, h:i is translated to Today, h:i.
	 * @param bool    $forcedate (optional) force non-relative date format.
	 ...
	 *
	 * @param string  $user_timezone (optional) Time zone of the current user.
	 ...
	 *
	 * @since 3.1
	 * @param string            $time     (optional) String in a format accepted by strtotime().
	 ...
	 * @param int     $data (optional) bit field value to use, or false to use $this->data['user_options']
	 ...
	 * @param int     $data  (optional) Current bit field value, or false to use $this->data['user_options']
