...
class language_file_loader {
	 ...
	 * @param array        $lang      (reference) Array reference containing language strings
	 */
	 ...
	 * @param array   $lang      (reference) Array reference of language strings
	 */
	 ...
	 * @param array   $lang (reference) Reference of the array of language strings
	 */
