...
class type_cast_helper implements \phpbb\request\type_cast_helper_interface
{
	 ...
	 * @param bool    $multibyte (optional) Indicates whether string values may contain UTF-8 characters.
	 ...
	 *         Default is true.
	 *
	 * @param string  $var       (reference) The value which shall be sanitised (passed by reference).
