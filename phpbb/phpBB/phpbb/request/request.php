...
class request implements \phpbb\request\request_interface
{
	 ...
	 *
	 * @param type_cast_helper_interface $type_cast_helper      (optional)
	 * @param unknown                    $disable_super_globals (optional)
	 */
	 ...
	 * @param string  $super_global (optional) (\phpbb\request\request_interface::POST|GET|REQUEST|COOKIE)
	 */
	 ...
	 * @param bool         $multibyte    (optional) If $default is a string this parameter has to be true if the variable may contain any UTF-8 characters
	 * @param string       $super_global (optional) (\phpbb\request\request_interface::POST|GET|REQUEST|COOKIE)
	 ...
	 * @param mixed        $default  (optional) See \phpbb\request\request_interface::variable
	 ...
	 * @param bool         $multibyte    (optional) If $default is a string this parameter has to be true if the variable may contain any UTF-8 characters
	 * @param string       $super_global (optional) (\phpbb\request\request_interface::POST|GET|REQUEST|COOKIE)
	 * @param bool         $trim         (optional) Indicates whether trim() should be applied to string values.
	 * @return mixed The value of $_REQUEST[$var_name] run through {@link set_var set_var} to ensure that the type is the
	 */
