...
abstract class attachments_base extends base
{
	 ...
	 *
	 * @param array   $post_ids  (optional) Specify for which post IDs to fetch the attachments (optional)
	 * @param array   $topic_ids (optional) Specify for which topic IDs to fetch the attachments (optional)
	 */
