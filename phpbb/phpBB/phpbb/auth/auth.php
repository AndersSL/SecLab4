...
class auth {
	 ...
	 * Init permissions
	 *
	 * @param unknown $userdata (reference)
	 */
	 ...
	 *
	 * @access private
	 * @param unknown $user_permissions
	 */
	 ...
	 * @param bool    $clean (optional) set to true if only values needs to be returned which are set/unset
...
*/
	 ...
	 *
	 * @param unknown $group_id (optional)
	 * @param unknown $opts     (optional)
	 * @param unknown $forum_id (optional)
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $key
	 * @param unknown $auth_options
	 * @param unknown $sql_opts     (reference)
	 */
