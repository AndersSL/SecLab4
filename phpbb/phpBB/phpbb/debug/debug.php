...
class debug {
	 ...
	 *
	 * @param int     $errorReportingLevel (optional) The level of error reporting you want
	 * @param bool    $displayErrors       (optional) Whether to display errors (for development) or just log them (for production)
	 */
