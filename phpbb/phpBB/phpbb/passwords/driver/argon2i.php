...
class argon2i extends base_native
{
	 ...
	 * @param int                            $memory_cost (optional) Maximum memory (optional)
	 * @param int                            $threads     (optional) Number of threads to use (optional)
	 * @param int                            $time_cost   (optional) Maximum amount of time (optional)
	 */
