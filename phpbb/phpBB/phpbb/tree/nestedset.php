...
abstract class nestedset implements \phpbb\tree\tree_interface
{
	 ...
	 * @param string                            $message_prefix  (optional) Prefix for the messages thrown by exceptions
	 * @param string                            $sql_where       (optional) Additional SQL restrictions for the queries
	 * @param array                             $item_basic_data (optional) Array with basic item data that is stored in item_parents
	 * @param array                             $columns         (optional) Array with column names to overwrite
	 */
	 ...
	 *
	 * @param string  $operator      (optional) SQL operator that needs to be prepended to sql_where,
	 * @param string  $column_prefix (optional) Prefix that needs to be prepended to column names
	 ...
	 * {@inheritdoc}
	 *
	 * @param unknown $current_parent_id
	 * @param unknown $new_parent_id
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $item_id
	 * @param unknown $order_asc    (optional)
	 * @param unknown $include_item (optional)
	 * @return unknown
	 */
	 ...
	 * @param bool    $order_asc    (optional) Order the items ascending by their left_id
	 * @param bool    $include_item (optional) Should the item matching the given item id be included in the list as well
	 ...
	 * @param bool    $set_subset_zero (optional) Should the parent, left and right id of the items be set to 0, or kept unchanged?
	 * @return null
	 */
	 ...
	 * @param bool    $reset_ids (optional) Should we reset all left_id/right_id on the first call?
