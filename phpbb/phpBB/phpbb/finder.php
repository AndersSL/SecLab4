...
class finder {
	 ...
	 *                           _ext_finder
	 *
	 * @param string                    $phpbb_root_path (optional) Path to the phpbb root directory
	 * @param \phpbb\cache\service|null $cache           A cache instance or null
	 * @param string                    $php_ext         (optional) php file extension
	 * @param string                    $cache_name      (optional) The name of the cache variable, defaults to
	 */
	 ...
	 * @param bool    $replace_list (optional) Should the list be emptied before adding the extensions
	 ...
	 *
	 * @param bool    $cache (optional) Whether the result should be cached
	 ...
	 *
	 * @param bool    $cache          (optional) Whether the result should be cached
	 * @param bool    $extension_keys (optional) Whether the result should have extension name as array key
	 ...
	 *
	 * @param bool    $cache          (optional) Whether the result should be cached
	 * @param bool    $is_dir         (optional) Directories will be returned when true, only files
	 * @param bool    $extension_keys (optional) If true, result will be associative array
