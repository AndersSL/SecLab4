...
class message {
	 ...
	 * @param int     $recipient_notify_type (optional) Used notification methods (Jabber, Email, ...)
	 * @param string  $recipient_username    (optional) User Name (used for AntiAbuse header)
	 * @param string  $recipient_jabber      (optional)
	 * @return null
	 */
	 ...
	 * @param string  $sender_lang     (optional)
	 * @param int     $sender_id       (optional) User ID
	 * @param string  $sender_username (optional) User Name (used for AntiAbuse header)
	 * @param string  $sender_jabber   (optional)
	 * @return null
	 */
