...
class manager {
	 ...
	 * @param array   $options     (optional) Optional options to control what notifications are loaded
	 ...
	 * @param bool|int|array    $user_id                User id or array of user ids. False to mark read for all user ids
	 * @param bool|int          $time                   Time at which to mark all notifications prior to as read. False to mark all as read. (Default: False)
	 * @param bool              $mark_read              (optional) Define if the notification as to be set to True or False. (Default: True)
	 */
	 ...
	 * @param mixed        $parent_id              (optional) Parent identifier within the type (or array of ids), used in combination with item_id if specified (Default: false; not checked)
	 * @param mixed        $user_id                (optional) User id (Default: false; not checked)
	 */
	 ...
	 * @param int      $item_id   (optional) The id of the item
	 * @param string   $method    (optional) The method of the notification e.g. 'board', 'email', or 'jabber'
	 * @param bool|int $user_id   The user_id to add the subscription for (bool false for current user)
	 */
	 ...
	 * @param bool    $only_read (optional) True (default) to only prune read notifications
	 */
