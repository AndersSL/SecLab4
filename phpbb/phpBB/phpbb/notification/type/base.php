...
abstract class base implements \phpbb\notification\type\type_interface
{
	 ...
	 *
	 * @param array   $data (optional) Row directly from the database
	 */
	 ...
	 * Mark this item read
	 *
	 * @param bool    $return (optional) True to return a string containing the SQL code to update this item, False to execute it (Default: False)
	 ...
	 *
	 * @param bool    $unread (optional) Unread (True/False) (Default: False)
	 * @param bool    $return (optional) True to return a string containing the SQL code to update this item, False to execute it (Default: False)
	 * @return string|null If $return is False, nothing will be returned, else the sql code to update this item
	 */
	 ...
	 * @param bool    $sort     (optional) Whether the users array should be sorted. Default: false
