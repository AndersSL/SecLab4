...
interface log_interface
{
	 ...
	 *       global log status.
	 *
	 * @param string  $type (optional) The log type we want to check. Empty to get
	 ...
	 *
	 * @param mixed   $type (optional) The log type we want to disable. Empty to
	 * @return null
	 */
	 ...
	 *
	 * @param mixed   $type (optional) The log type we want to enable. Empty to
	 * @return null
	 */
	 ...
	 * @param array    $additional_data (optional) More arguments can be added, depending on the log_type
	 ...
	 * @param array   $conditions (optional) An array of conditions, 3 different  forms are accepted
	 */
	 ...
	 * @param bool    $count_logs (optional) Shall we count all matching log entries?
	 ...
	 * @param int     $log_time   (optional) Only get log entries newer than the given timestamp
