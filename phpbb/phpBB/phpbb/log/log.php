...
class log implements \phpbb\log\log_interface
{
	 ...
	 * @param string  $table_alias        (optional) The alias of the logs' table ('l.' by default)
	 * @param string  $statement_operator (optional) The operator used to prefix the statement ('AND' by default)
