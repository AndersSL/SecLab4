...
class user_loader {
	 ...
	 * @param array   $ignore_types (optional) user types to ignore
	 */
	 ...
	 * @param bool    $query   (optional) Should we query the database if this user has not yet been loaded?
