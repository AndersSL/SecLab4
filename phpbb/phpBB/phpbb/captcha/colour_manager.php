...
class colour_manager {
	 ...
	 *
	 * @param unknown $img
	 * @param unknown $background (optional)
	 ...
	 *
	 * @param unknown $resource
	 * @param unknown $include_original (optional)
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $colour
	 * @param unknown $from_model
	 * @param unknown $to_model
	 * @return unknown
	 */
