...
class char_cube3d {
	...
	/**
	 *
	 * @param unknown $bitmaps (reference)
	...
	*/
	 ...
	 * Normalize
	 *
	 * @param unknown $vector (reference)
	...
	/**
	 *
	 * @param unknown $vector1
	 * @param unknown $vector2
	 * @return unknown
	 */
	 ...
	 * @param unknown $xoff
	 * @param unknown $yoff
	 * @param unknown $vec1 (reference)
	 * @param unknown $vec2 (reference)
	 * @param unknown $vec3 (reference)
	 * @param unknown $vec4 (reference)
	 * @return unknown
	 */
