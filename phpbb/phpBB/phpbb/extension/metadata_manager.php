...
class metadata_manager {
	 ...
	 *
	 * @param string  $element (optional) All for all metadata that it has and is valid, otherwise specify which section you want by its shorthand term.
	 ...
	 *
	 * @param mixed   $value (reference) Value of array row
	 ...
	 *
	 * @throws \phpbb\extension\exception
	 * @param string  $name (optional) ("all" for display and enable validation
