...
class manager {
	 ...
	 * @param string                            $php_ext         (optional) php file extension, defaults to php
	 * @param \phpbb\cache\service|null         $cache           A cache instance or null
	 * @param string                            $cache_name      (optional) The name of the cache variable, defaults to _ext
	 */
	 ...
	 * @param bool    $phpbb_relative (optional) Whether the path should be relative to phpbb root
	 ...
	 * @param string  $action (optional) Action to perform, by default 'update', may be also 'insert' or 'delete'
	 */
	 ...
	 * @param bool                              $force_update (optional) Ignores cached data. Defaults to false.
	 * @param bool                              $force_cache  (optional) Force the use of the cache. Override $force_update.
	 * @param string                            $stability    (optional) Force the stability (null by default).
	 * @return array
	 */
	 ...
	 *
	 * @param bool    $use_all_available (optional) Should we load all extensions, or just enabled ones
