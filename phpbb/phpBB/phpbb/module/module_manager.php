...
class module_manager {
	 ...
	 *
	 * @param string  $module_class      Class of the module (acp, ucp, mcp etc...)
	 * @param string  $module            (optional) ID of module
	 * @param bool    $use_all_available (optional) Use all available instead of just all
	 ...
	 * @param int     $module_id      ID of the module
	 * @param string  $module_class   Class of the module (acp, ucp, mcp etc...)
	 * @param string  $type           (optional) Type of branch (Expected values: all, parents or children)
	 * @param bool    $include_module (optional) Whether or not to include the specified module with $module_id
	 ...
	 * @param string  $module_class Class of the module (acp, ucp, mcp etc...)
	 * @param string  $action       (optional) Direction of moving (valid values: move_up or move_down)
	 * @param int     $steps        (optional) Number of steps to move module
