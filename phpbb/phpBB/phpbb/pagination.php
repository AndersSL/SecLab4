...
class pagination {
	 ...
	 * @param int          $per_page       the number of items, posts, etc. to display per page, used to determine the number of pages to produce
	 * @param int          $start          (optional) the item which should be considered currently active, used to determine the page we're on
	 * @param bool         $reverse_count  (optional) determines whether we weight display of the list towards the start (false) or end (true) of the list
	 * @param bool         $ignore_on_page (optional) decides whether we enable an active (unlinked) item, used primarily for embedded lists
	 * @return void
	 */
