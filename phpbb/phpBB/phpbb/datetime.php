...
class datetime extends \DateTime
{
	 ...
	 *
	 * @param string  $format         (optional) Optional format to use for output, defaults to users chosen format
	 * @param boolean $force_absolute (optional) Force output of a non relative date
