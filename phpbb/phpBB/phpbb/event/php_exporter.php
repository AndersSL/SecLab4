...
class php_exporter {
	 ...
	 * @param mixed   $extension       (optional) String 'vendor/ext' to filter, null for phpBB core
	 * @param string  $min_version     (optional)
	 ...
	 * @throws \LogicException
	 * @param string  $line
	 * @param bool    $throw_multiline (optional) Throw an exception when there are too
	 * @return array  List of variables
	 */
	 ...
	 * @param int     $skip_to_line    (optional) Skip lines until this one
	 * @return int Absolute line number
	 */
