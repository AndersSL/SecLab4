...
class helper {
	 ...
	 * @param string  $group_colour       (optional) The group colour
	 * @param mixed   $custom_profile_url (optional) optional parameter to specify a profile url. The group id gets appended to this url as &amp;g={group_id}
