...
class content_visibility {
	 ...
	 *
	 * @param unknown $forum_id    int  Forum ID whose permissions to check
	 * @param unknown $poster_id   int  Poster ID of the post in question
	 * @param unknown $post_locked bool Is the post locked?
	 * @return bool
	 */
	 ...
	 *
	 * @param unknown $mode     string One of topic_posts, forum_posts or forum_topics
	 * @param unknown $data     array Array with the topic/forum data to calculate from
	 * @param unknown $forum_id int  The forum id is used for permission checks
	 ...
	 *
	 * @param unknown $mode     string Either "topic" or "post"
	 * @param unknown $forum_id int  The forum id is used for permission checks
	 * @param unknown $data     array Array with item information to check visibility
	 ...
	 * @param unknown $mode        string Either "topic" or "post"
	 * @param unknown $forum_id    int  The forum id is used for permission checks
	 * @param unknown $table_alias (optional) string Table alias to prefix in SQL queries
	 ...
	 *
	 * @param unknown $mode        string Either "topic" or "post"
	 * @param unknown $forum_ids   (optional) array Array of forum ids which the posts/topics are limited to
	 * @param unknown $table_alias (optional) string Table alias to prefix in SQL queries
	 * @return string The appropriate combination SQL logic for topic/post_visibility
	 */
	 ...
	 *
	 * @param unknown $mode              string Either "topic" or "post"
	 * @param unknown $exclude_forum_ids (optional) array Array of forum ids which are excluded
	 * @param unknown $table_alias       (optional) string Table alias to prefix in SQL queries
	 * @return string The appropriate combination SQL logic for topic/post_visibility
	 */
	 ...
	 *
	 * @param unknown $visibility        int  Element of {ITEM_APPROVED, ITEM_DELETED, ITEM_REAPPROVE}
	 * @param unknown $post_id           mixed Post ID or array of post IDs to act on,
	 * @param unknown $topic_id          int  Topic where $post_id is found
	 * @param unknown $forum_id          int  Forum where $topic_id is found
	 * @param unknown $user_id           int  User performing the action
	 * @param unknown $time              int  Timestamp when the action is performed
	 * @param unknown $reason            string Reason why the visibility was changed.
	 * @param unknown $is_starter        bool Is this the first post of the topic changed?
	 * @param unknown $is_latest         bool Is this the last post of the topic changed?
	 * @param unknown $limit_visibility  (optional) mixed Limit updating per topic_id to a certain visibility
	 * @param unknown $limit_delete_time (optional) mixed Limit updating per topic_id to a certain deletion time
	 ...
	 *
	 * @param unknown $visibility       int  Element of {ITEM_APPROVED, ITEM_DELETED, ITEM_REAPPROVE}
	 * @param unknown $topic_id         mixed Topic ID to act on
	 * @param unknown $forum_id         int  Forum where $topic_id is found
	 * @param unknown $user_id          int  User performing the action
	 * @param unknown $time             int  Timestamp when the action is performed
	 * @param unknown $reason           string Reason why the visibilty was changed.
	 * @param unknown $force_update_all (optional) bool Force to update all posts within the topic
	 ...
	 *
	 * @param unknown $data     array Contains information from the topics table about given topic
	 * @param unknown $sql_data (reference) array Populated with the SQL changes, may be empty at call time (by reference)
	 * @return null
	 */
	 ...
	 *
	 * @param unknown $data     array Post and topic data
	 * @param unknown $sql_data (reference) array Populated with the SQL changes, may be empty at call time (by reference)
	 * @return null
	 */
