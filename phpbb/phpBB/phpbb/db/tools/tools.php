...
class tools implements tools_interface
{
	 ...
	 * @param bool                              $return_statements (optional) True if only statements should be returned and no SQL being executed
	 */
	 ...
	 * @param bool    $throw_error (optional)
	 ...
	 * @param bool    $unique      (optional) Should we get unique indexes or normal ones
	 ...
	 *
	 * @param string  $table_name
	 * @param string  $remove_column (optional) When we drop a column, we remove the column
	 * @return array
	 */
