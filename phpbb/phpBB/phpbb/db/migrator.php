...
class migrator {
	 ...
	 * @param unknown                 $migrations_table
	 ...
	 * @param bool        $revert (optional) true to revert a data step
	 ...
	 * @param mixed   $last_result (optional) Result to pass to the callable (only for 'custom' method)
	 * @param bool    $reverse     (optional) False to install, True to attempt uninstallation by reversing the call
	 * @return null
	 */
