...
class module implements \phpbb\db\migration\tool\tool_interface
{
	 ...
	 * @param bool            $lazy   (optional) Checks lazily if the module exists. Returns true if it exists in at
	 ...
	 * @param array      $data   (optional) an array of the data on the new \module.
	 * @return null
	 */
	 ...
	 * @param bool             $throw_exception (optional) The flag indicating if exception should be thrown on error
