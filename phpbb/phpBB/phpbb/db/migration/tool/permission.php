...
class permission implements \phpbb\db\migration\tool\tool_interface
{
	 ...
	 * @param bool    $global      (optional) True for checking a global permission setting,
	 ...
	 * @param string  $role_description (optional) Description of the new role
	 * @return null
	 */
	 ...
	 * @param string       $type           (optional) The type (role|group)
	 * @param bool         $has_permission (optional) True if you want to give them permission,
	 * @return null
	 */
