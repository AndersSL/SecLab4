...
class environment extends \Twig\Environment
{
	 ...
	 * @param array                             $options           (optional) Array of options to pass to Twig
	 */
	 ...
	 *
	 * @param string  $output
	 * @param unknown $placeholder_salt
	 * @return string
	 */
	 ...
	 * @param integer $index (optional) The index if it is an embedded template
