...
class icon extends \Twig\Extension\AbstractExtension
{
	 ...
	 * @param bool        $hidden      (optional) Hide the icon title from view
	 * @param string      $classes     (optional) Additional classes (eg. "fa-fw")
	 * @param array       $attributes  (optional) Additional attributes for the icon, where the key is the attribute.
	 * @return string
	 */
	 ...
	 * @param string                $view_box (optional, reference) The viewBox attribute value
