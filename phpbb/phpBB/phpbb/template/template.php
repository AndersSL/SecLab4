...
interface template
{
	 ...
	 *
	 * @param array   $style_directories (optional) The directories to add style paths for
	 * @return \phpbb\template\template $this
	 */
	 ...
	 * @param string  $template_var   (optional) Template variable to assign compiled handle to
	 * @param bool    $return_content (optional) If true return compiled handle, otherwise assign to $template_var
	 ...
	 * @param mixed   $key       (optional) Key to search for
	 * @param string  $mode      (optional) Mode to execute (valid modes are 'insert', 'change' and 'delete')
