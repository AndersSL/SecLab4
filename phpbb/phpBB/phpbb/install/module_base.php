...
abstract class module_base implements module_interface
{
	 ...
	 * @param bool                       $essential          (optional) flag indicating whether the module is essential or not
	 * @param bool                       $allow_progress_bar (optional) flag indicating whether or not to send progress information from within the module
	 */
