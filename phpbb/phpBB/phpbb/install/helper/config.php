...
class config {
	 ...
	 * @param mixed   $default    (optional) Default value to return when the specified data
	 ...
	 *
	 * @param int     $increment_by (optional) The amount to increment by
	 */
