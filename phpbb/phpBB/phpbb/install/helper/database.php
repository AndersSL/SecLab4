...
class database {
	 ...
	 *           returned as well
	 *
	 * @param mixed   $dbms               (optional) name of the DBMS that's info is required or false for all DBMS info
	 * @param bool    $return_unavailable (optional) set it to true if you expect unavailable but supported DBMS
	 * @param bool    $only_20x_options   (optional) set it to true if you only want to recover 2.0.x options
