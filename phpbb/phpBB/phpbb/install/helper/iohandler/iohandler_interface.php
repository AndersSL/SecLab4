...
interface iohandler_interface
{
	 ...
	 *
	 * @param bool    $no_more_output (optional) Whether or not there will be more output in this output unit
	 */
	 ...
	 * @param mixed   $default (optional) Default value to return when the requested variable does not exist
	 ...
	 * @param bool    $restart    (optional) Whether or not to restart the progress bar, false by default
	 */
	 ...
	 * @param bool    $use_ajax (optional) Whether or not to use AJAX redirect
	 */
