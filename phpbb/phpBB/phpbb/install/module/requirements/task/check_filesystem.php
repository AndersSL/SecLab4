...
class check_filesystem extends \phpbb\install\task_base
{
	 ...
	 * @param bool                                                $check_config_php (optional) Whether or not to check if config.php is writable
	 */
	 ...
	 * @param bool    $failable (optional) Whether failing test should interrupt installation process
	 */
	 ...
	 * @param bool    $failable (optional) Whether failing test should abort the installation process
	 */
