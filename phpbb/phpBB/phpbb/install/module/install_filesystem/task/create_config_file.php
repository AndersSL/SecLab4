...
class create_config_file extends \phpbb\install\task_base
{
	 ...
	 *
	 * @param bool    $debug           (optional) If the debug constants should be enabled by default or not
	 * @param bool    $debug_container (optional) If the container should be compiled on
	 * @param string  $environment     (optional) The environment to use
