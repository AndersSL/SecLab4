...
class fulltext_sphinx {
	 ...
	 *
	 * @param string  $keywords (reference) Contains the keyword as entered by the user
	 ...
	 * @param int     $start           (reference) indicates the first index of the page
	 ...
	 * @param unknown $author_ids
	 * @param unknown $forum_ids
	 */
	 ...
	 * Create sphinx table
	 *
	 * @param unknown $acp_module
	 * @param unknown $u_action
	 ...
	 *
	 * @param unknown $allow_new_files (optional)
