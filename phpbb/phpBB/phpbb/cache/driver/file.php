...
class file extends \phpbb\cache\driver\base
{
	 ...
	 * Set cache path
	 *
	 * @param string  $cache_dir (optional) Define the path to the cache directory (default: $phpbb_root_path . 'cache/')
	 */
	 ...
	 * @param int     $expires  (optional) Timestamp when the data expires
	 * @param string  $query    (optional) Query when caching SQL queries
