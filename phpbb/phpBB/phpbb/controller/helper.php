...
class helper {
	 ...
	 * @param bool              $sql_explain     (optional) Flag whether to display sql explain
	 */
	 ...
	 * @param string  $page_title          (optional) The title of the page to output
	 * @param int     $status_code         (optional) The status code to be sent to the page header
	 * @param bool    $display_online_list (optional) Do we display online users list
	 * @param int     $item_id             (optional) Restrict online users to item id
	 * @param string  $item                (optional) Restrict online users to a certain session item, e.g. forum for session_forum_id
	 * @param bool    $send_headers        (optional) Whether headers should be sent by page_header(). Defaults to false for controllers.
	 ...
	 * @param array       $params         (optional) String or array of additional url parameters
	 ...
	 * @param int         $reference_type (optional) The type of reference to be generated (one of the constants)
	 ...
	 * @param int     $code    (optional) The error code (e.g. 404, 500, 503, etc.)
	 ...
	 * @param string  $title      (optional) Title for the message (must be a language variable)
	 * @param int     $code       (optional) The HTTP status code (e.g. 404, 500, 503, etc.)
	 * @return Response A Response instance
	 */
	 ...
	 *
	 *
	 * @param bool    $run_cron (optional) Flag whether cron should be run
	 * @return void
	 */
