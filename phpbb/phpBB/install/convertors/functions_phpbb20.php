 ...
 * @param bool    $grab_user_lang (optional) if set to true the function tries to use $convert_row['user_lang'] (and falls back to $convert_row['poster_id']) instead of the boards default language
 * @return unknown
 */
 ...
 *
 * @param unknown $birthday (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $forum_permissions
 * @return unknown
 */
