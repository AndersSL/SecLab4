...
class convertor {
	...
	/**
	 *
	 * @param unknown $schema        (reference)
	 * @param unknown $sql_data      (reference)
	 * @param unknown $current_table
	 * @return unknown
	 */
	 ...
	 * @param unknown $schema        (reference)
	 * @param unknown $sql_data      (reference)
	 * @param unknown $insert_values (reference)
	 * @return unknown
	 */
