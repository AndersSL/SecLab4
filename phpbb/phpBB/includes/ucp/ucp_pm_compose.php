 ...
 * @param unknown $user_folders (optional)
 */
 ...
 *
 * @param unknown $address_list (reference)
 * @param unknown $error        (reference)
 * @param unknown $remove_u
 * @param unknown $remove_g
 * @param unknown $add_to
 * @param unknown $add_bcc
 */
 ...
 *
 * @param unknown $address_list
 * @param unknown $num_recipients (optional)
 * @return unknown
 */
