...
class messenger {
	 ...
	 * Constructor
	 *
	 * @param unknown $use_queue (optional)
	 */
	 ...
	 * @param unknown $realname (optional)
	 */
	 ...
	 *
	 * @param unknown $subject (optional)
	 */
	 ...
	 *
	 * @param unknown $template_file
	 * @param unknown $template_lang       (optional)
	 * @param unknown $template_path       (optional)
	 * @param unknown $template_dir_prefix (optional)
	 * @return unknown
	 */
	 ...
	 *
	 * @param int     $method (optional) User notification method NOTIFY_EMAIL|NOTIFY_IM|NOTIFY_BOTH
	 * @param bool    $break  (optional) Flag indicating if the function only formats the subject
	 * @return bool
	 */
 ...
 * @param unknown $err_msg   (reference)
...
class smtp_class {
	 ...
	 * @param unknown $private_info (optional)
	 */
	 ...
	 * @param unknown $default_auth_method
	 * @return unknown
	 */
 ...
 *
 * @param unknown $str
 * @param string  $eol (optional) End of line we are using (optional to be backwards compatible)
 * @return unknown
 */
