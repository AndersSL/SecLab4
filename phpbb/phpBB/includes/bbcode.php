...
class bbcode {
	 ...
	 *
	 * @param string  $bitfield (optional) The bbcode bitfield
	 */
	 ...
	 * @param unknown $bbcode_uid      (optional)
	 * @param unknown $bbcode_bitfield (optional)
	 */
	 ...
	 * @param unknown $bbcode_id           (optional)
	 * @param unknown $skip_bitfield_check (optional)
	 * @return unknown
	 */
