...
class bbcode_firstpass extends bbcode
{
	 ...
	 *
	 * @param unknown $allow_custom_bbcode (optional)
	 * @return unknown
	 */
	 ...
	 *
	 * @param unknown $bbcode
	 * @param unknown $in     (reference)
	 * @return unknown
	 */
...
class parse_message extends bbcode_firstpass
{
	 ...
	 * Parse Message
	 *
	 * @param unknown $allow_bbcode
	 * @param unknown $allow_magic_url
	 * @param unknown $allow_smilies
	 * @param unknown $allow_img_bbcode    (optional)
	 * @param unknown $allow_flash_bbcode  (optional)
	 * @param unknown $allow_quote_bbcode  (optional)
	 * @param unknown $allow_url_bbcode    (optional)
	 * @param unknown $update_this_message (optional)
	 ...
	 *
	 * @param unknown $custom_bbcode_uid   (optional)
	 * @param unknown $update_this_message (optional)
	 * @return unknown
	 */
	 ...
	 * Parse Smilies
	 *
	 * @param unknown $max_smilies (optional)
	 */
	 ...
	 * @param unknown $submit
	 * @param unknown $preview
	 * @param unknown $refresh
	 * @param unknown $is_message (optional)
	 * @return unknown
	 */
	 ...
	 * Get Attachment Data
	 *
	 * @param unknown $check_user_id (optional)
	 */
