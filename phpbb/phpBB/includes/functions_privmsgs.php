 ...
 * @param unknown $folder_id (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $num_sentbox_messages
 */
 ...
 *
 * @param unknown $rules       (reference)
 * @param unknown $rule_row    (reference)
 * @param unknown $message_row (reference)
 * @param unknown $user_id
 * @return unknown
 */
 ...
 *
 * @param unknown $global_privmsgs_rules (reference)
 * @param unknown $release               (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $user_id
 * @param unknown $message_limit
 * @param unknown $move_msg_ids
 * @param unknown $dest_folder
 * @param unknown $cur_folder_id
 * @return unknown
 */
 ...
 * @param unknown $plaintext (optional)
 * @return unknown
 */
 ...
 * @param unknown $put_in_outbox (optional)
 * @return unknown
 */
 ...
 * @param unknown $msg_id
 * @param unknown $user_id
 * @param unknown $message_row
 * @param unknown $folder
 * @param unknown $in_post_mode (optional)
 * @return unknown
 */
