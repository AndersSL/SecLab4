 ...
 * @param mixed   $user_type         (optional) Array of user types to check, false if not restricting by user type
 * @param boolean $update_references (optional) If false, the supplied array is unset and appears unchanged from where it was called
 ...
 * @param array   $cp_data            (optional) custom profile fields, see custom_profile::build_insert_sql_array
 * @param array   $notifications_data (optional) The notifications settings for the new user
 ...
 * @param bool    $retain_username (optional) True if username should be retained, false otherwise
 * @return bool
 */
 ...
 * @param unknown $ban_give_reason (optional)
 * @return boolean
 */
 ...
 * @param unknown $allowed_username (optional)
 * @param unknown $allow_all_names  (optional)
 * @return unknown
 */
 ...
 *
 * @param string  $email         The email to check
 * @param string  $allowed_email (optional) An allowed email, default being $user->data['user_email']
 * @return mixed Either false if validation succeeded or a string which will be used as the error message (with the variable name appended)
 */
 ...
 * @param bool    $optional (optional) Whether the colour value is optional. True if an empty
 ...
 * @param unknown $mode
 * @param unknown $row
 * @param unknown $clean_db (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $group_id           (reference)
 * @param unknown $type
 * @param unknown $name
 * @param unknown $desc
 * @param unknown $group_attributes
 * @param unknown $allow_desc_bbcode  (optional)
 * @param unknown $allow_desc_urls    (optional)
 * @param unknown $allow_desc_smilies (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $group_id
 * @param unknown $group_name (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $group_id
 * @param unknown $user_id_ary      (optional)
 * @param unknown $username_ary     (optional)
 * @param unknown $group_name       (optional)
 * @param unknown $default          (optional)
 * @param unknown $leader           (optional)
 * @param unknown $pending          (optional)
 * @param unknown $group_attributes (optional)
 ...
 * @param unknown $username_ary (optional)
 * @param unknown $group_name   (optional)
 * @param unknown $log_action   (optional)
 ...
 * @param unknown $user_id_ary
 * @param unknown $group_attributes (optional)
 * @param unknown $update_listing   (optional)
 */
 ...
 *
 * @param unknown $group_id_ary (optional)
 * @param unknown $user_id_ary  (optional)
 * @param unknown $return_bool  (optional)
 * @return unknown
 */
 ...
 *
 * @access public
 * @param unknown $user_id   The id of the user to remove from the group
 * @param unknown $user_data (optional)
 * @return unknown
 */
 ...
 *
 * @param array    $user_ids (optional) Array of users' ids to check for banning,
 ...
 *
 * @param unknown $mode
 * @param unknown $module_row (reference)
 */
