 ...
 *
 * @param int     $new_id    (reference) first left_id (should start with 1)
 ...
 * @param int     $parent_id (optional) parent_id of the current set (default = 0)
 * @param array   $where     (optional) contains strings to compare closer on the where statement (additional)
 */
 ...
 *
 * @param unknown $select_id       (optional)
 * @param unknown $ignore_id       (optional)
 * @param unknown $ignore_acl      (optional)
 * @param unknown $ignore_nonpost  (optional)
 * @param unknown $ignore_emptycat (optional)
 * @param unknown $only_acl_post   (optional)
 * @param unknown $return_array    (optional)
 * @return unknown
 */
 ...
 * @param array   $exclude_ids    (optional) The group ids to exclude from the list, false (default) if you whish to exclude no id
 * @param int     $manage_founder (optional) If set to false (default) all groups are returned, if 0 only those groups returned not being managed by founders only, if 1 only those groups returned managed by founders only.
 ...
 *
 * @param unknown $acl_list      (optional)
 * @param unknown $id_only       (optional)
 * @param unknown $postable_only (optional)
 * @param unknown $no_cache      (optional)
 * @return unknown
 */
 ...
 * @param unknown $include_forum (optional)
 * @return unknown
 */
 ...
 * @param bool    $clear_dest_perms (optional) True if destination permissions should be deleted
 * @param bool    $add_log          (optional) True if log entry should be added
 ...
 * @param unknown $forum_id
 * @param unknown $auto_sync (optional)
 */
 ...
 * Remove topic(s)
 *
 * @param unknown $where_type
 * @param unknown $where_ids
 * @param unknown $auto_sync         (optional)
 * @param unknown $post_count_sync   (optional)
 * @param unknown $call_delete_posts (optional)
 * @return unknown
 */
 ...
 * @param unknown $where_ids
 * @param unknown $auto_sync          (optional)
 * @param unknown $posted_sync        (optional)
 * @param unknown $post_count_sync    (optional)
 * @param unknown $call_delete_topics (optional)
 * @return unknown
 */
 ...
 * @param string  $sql_more  (optional) Additional WHERE statement, e.g. t.topic_time < (time() - 1234)
 * @param bool    $auto_sync (optional) Will call sync() if this is true
 ...
 *
 * @param unknown $topic_ids (reference)
 */
 ...
 *
 * @param unknown $mode
 * @param unknown $where_type     (optional)
 * @param unknown $where_ids      (optional)
 * @param unknown $resync_parents (optional)
 * @param unknown $sync_extra     (optional)
 */
 ...
 *
 * @param unknown $forum_id
 * @param unknown $prune_mode
 * @param unknown $prune_date
 * @param unknown $prune_flags (optional)
 * @param unknown $auto_sync   (optional)
 * @param unknown $prune_limit (optional)
 * @return unknown
 */
 ...
 * @param unknown $forum_id
 * @param unknown $prune_mode
 * @param unknown $prune_flags
 * @param unknown $prune_days
 * @param unknown $prune_freq
 * @param unknown $log_prune   (optional)
 */
 ...
 * @param int     $limit      (optional) Limit the number of entries that are returned
 * @param int     $offset     (optional) Offset when fetching the log entries, f.e. when paginating
 * @param mixed   $forum_id   (optional) Restrict the log entries to the given forum_id (can also be an array of forum_ids)
 * @param int     $topic_id   (optional) Restrict the log entries to the given topic_id
 * @param int     $user_id    (optional) Restrict the log entries to the given user_id
 * @param int     $limit_days (optional) Only get log entries newer than the given timestamp
 * @param string  $sort_by    (optional) SQL order option, e.g. 'l.log_time DESC'
 * @param string  $keywords   (optional) Will only return log entries that have the keywords in log_operation or log_data
 ...
 *
 * @param unknown $users      (reference)
 * @param unknown $user_count (reference)
 * @param unknown $limit      (optional)
 * @param unknown $offset     (optional)
 * @param unknown $limit_days (optional)
 ...
 * @param string  $sql_more    (optional) This string is attached to the sql query generated to update the table.
 * @return null
 */
