...
class diff {
	 ...
	 * @param bool    $preserve_cr       (optional) If true, \r is replaced by a new line in the diff output
	 * @param unknown $from_lines        (reference)
	 * @param unknown $to_lines          (reference)
	 * @param unknown $mapped_from_lines (reference)
	 * @param unknown $mapped_to_lines   (reference)
	 * @param unknown $orig
	 * @param unknown $final             (optional)
	 * @param unknown $lines
	 * @param unknown $final1            (reference)
	 * @param unknown $final2            (reference)
	 * @return unknown
	 */
...
class mapped_diff extends diff
{
	 ...
	 *
	 * @param unknown $from_content      (reference)
	 * @param unknown $to_content        (reference)
	 * @param unknown $preserve_cr       (optional)
	 * @param array   $from_lines        (reference) An array of strings.
	 * @param array   $to_lines          (reference) An array of strings.
	 * @param array   $mapped_from_lines (reference) This array should have the same size number of elements as $from_lines.
	 * @param array   $mapped_to_lines   (reference) This array should have the same number of elements as $to_lines.
	 * @param unknown $orig
	 * @param unknown $final             (optional)
	 * @param unknown $lines
	 * @param unknown $final1            (reference)
...
class diff3 extends diff
{
	 ...
	 * @param unknown $from_content      (reference)
	 * @param unknown $to_content        (reference)
	 * @param bool    $preserve_cr       (optional) If true, \r\n and bare \r are replaced by a new line
	 * @param unknown $from_lines        (reference)
	 * @param unknown $to_lines          (reference)
	 * @param unknown $mapped_from_lines (reference)
	 * @param unknown $mapped_to_lines   (reference)
	 ...
	 *
	 *
	 * @param string  $label1    (optional) the cvs file version/label from the original set of lines
	 * @param string  $label2    (optional) the cvs file version/label from the new set of lines
	 * @param string  $label_sep (optional) the explanation between label1 and label2 - more of a helper for the user
	 ...
	 *
	 * @access private
	 * @param unknown $edits1 (reference)
	 * @param unknown $edits2 (reference)
	 * @return unknown
	 */
...
class diff3_op {
	 ...
	 * @author acydburn
	 * @param unknown $orig
	 * @param unknown $final1
	 * @param unknown $final2 (optional)
	 * @return unknown
	 */
