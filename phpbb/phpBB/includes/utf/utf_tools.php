 ...
 * @param int     $split_len (optional) number to characters to split string by
 ...
 * @param string  $option (optional) determines how we will fold the cases
 ...
 * @param int     $width  (optional) The column width. Defaults to 75.
 * @param string  $break  (optional) The line is broken using the optional break parameter. Defaults to '\n'.
 * @param bool    $cut    (optional) If the cut is set to TRUE, the string is always wrapped at the specified width. So if you have a word that is larger than the given width, it is broken apart.
