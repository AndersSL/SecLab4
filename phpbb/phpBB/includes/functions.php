 ...
 *
 * @param int     $num_chars (optional) Length of random string, defaults to 8.
 * @return string
 */
 ...
 *
 * @param int     $time (optional) Unix timestamp (optional)
 ...
 * @param bool    $string_only   (optional) true if language string should be returned
 * @param array   $allowed_units (optional) only allow these units (data array indexes)
 ...
 *
 * @param unknown $extra_time (optional)
 ...
 * @param string  $operator (optional) Comparison operator (optional)
 ...
 * @param bool    $show_null (optional) Whether null offsets should be shown
 ...
 * @param string                   $default  (optional) A timezone to select
 * @param boolean                  $truncate (optional) Shall we truncate the options text
 ...
 * @param int      $post_time (optional) 0 means current time(), otherwise to set a specific mark time
 * @param int      $user_id   (optional) can only be used with $mode == 'post'
 */
 ...
 * @param unknown $rowset          (reference)
 * @param unknown $forum_mark_time
 * @return unknown
 */
 ...
 *
 *
 * @param int     $user_id          (optional) User ID (or false for current user)
 * @param string  $sql_extra        (optional) Extra WHERE SQL statement
 * @param string  $sql_sort         (optional) ORDER BY SQL sorting statement
 * @param string  $sql_limit        (optional) Limits the size of unread topics list, 0 for unlimited query
 * @param string  $sql_limit_offset (optional) Sets the offset of the first row to search, 0 to search from the start
 ...
 * @param int     $f_mark_time          (optional) the forums last mark time if user is registered and load_db_lastread enabled
 * @param int     $mark_time_forum      (optional) false if the mark time needs to be obtained, else the last users forum mark time
 ...
 * @param unknown $max_depth (optional)
 * @return unknown
 */
 ...
 * @param mixed   $params     (optional) String or array of additional url parameters
 * @param bool    $is_amp     (optional) Is url using &amp; (true) or & (false)
 * @param string  $session_id (optional) Possibility to use a custom session id instead of the global one
 * @param bool    $is_route   (optional) Is url generated by a route.
 ...
 *
 *
 * @param bool    $without_script_path (optional) if set to true the script path gets not appended (example: http://www.example.com)
 ...
 * @param bool    $return           (optional) If true, do not redirect but return the sanitized URL. Default is no return.
 * @param bool    $disable_cd_check (optional) If true, redirect() will redirect to an external domain. If false, the redirect point to the boards url if it does not match the current domain. Default is false.
 * @return unknown
 */
 ...
 *
 * @param unknown $url
 * @param unknown $is_route (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $strip_vars (optional)
 * @return unknown
 */
 ...
 * @param bool    $disable_cd_check (optional) If true, meta_refresh() will redirect to an external domain. If false, the redirect point to the boards url if it does not match the current domain. Default is false.
 * @return unknown
 */
 ...
 * @param string  $template_variable_suffix (optional) A string that is appended to the name of the template variable to which the form elements are assigned
 */
 ...
 * @param int     $timespan  (optional) The maximum acceptable age for a submitted form
 ...
 * @param string       $hidden    (optional) Hidden variables
 * @param string       $html_body (optional) Template used for confirm box
 * @param string       $u_action  (optional) Custom form action
 ...
 * @param unknown $l_explain (optional)
 * @param unknown $l_success (optional)
 * @param unknown $admin     (optional)
 * @param unknown $s_display (optional)
 */
 ...
 * @param unknown $key
 * @param unknown $value
 * @param unknown $specialchar
 * @param unknown $stripslashes
 * @return unknown
 */
 ...
 * @param bool    $specialchar  (optional) if true, keys and values get specialchared
 * @param bool    $stripslashes (optional) if true, keys and values get stripslashed
 ...
 *
 * @param int     $item_id (optional) Limits the search to the item with this id
 * @param string  $item    (optional) The name of the item which is stored in the session table as session_{$item}_id
 ...
 * @param int     $item_id      (optional) Indicate that the data is limited to one item and not global
 * @param string  $item         (optional) The name of the item which is stored in the session table as session_{$item}_id
 ...
 * @param array   $entities (optional) Associative array of additional entities to be escaped
 ...
 * @param string  $alt           (optional) Optional language string for alt tag within image, can be a language key or text
 * @param bool    $ignore_config (optional) Ignores the config-setting, to be still able to view the avatar in the UCP
 * @param bool    $lazy          (optional) If true, will be lazy loaded (requires JS)
 ...
 *
 * @param unknown $page_title          (optional)
 * @param unknown $display_online_list (optional)
 * @param unknown $item_id             (optional)
 * @param unknown $item                (optional)
 * @param unknown $send_headers        (optional)
 */
 ...
 *
 * @param bool    $run_cron         (optional) Whether or not to run the cron
 * @param bool    $display_template (optional) Whether or not to display the template
 * @param bool    $exit_handler     (optional) Whether or not to run the exit_handler()
 */
