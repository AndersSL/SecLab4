...
class jabber {
	 ...
	 * @param boold   $use_ssl           (optional) Use ssl
	 * @param bool    $verify_peer       (optional) Verify SSL certificate
	 * @param bool    $verify_peer_name  (optional) Verify Jabber peer name
	 * @param bool    $allow_self_signed (optional) Allow self signed certificates
	 */
	 ...
	 *
	 * @access public
	 * @param unknown $message     (optional) online, offline...
	 * @param unknown $type        (optional) dnd, away, chat, xa or nothing
	 * @param unknown $unavailable (optional) set this to true if you want to become unavailable
	 * @return bool
	 */
	 ...
	 * @param unknown $data
	 * @param unknown $skip_white (optional)
