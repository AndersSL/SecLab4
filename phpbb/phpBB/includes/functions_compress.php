...
class compress {
	 ...
	 *
	 * @param unknown $src
	 * @param unknown $src_rm_prefix  (optional)
	 * @param unknown $src_add_prefix (optional)
	 * @param unknown $skip_files     (optional)
	 * @return unknown
	 */
...
class compress_zip extends compress
{
	 ...
	 *
	 * @param unknown $filename
	 * @param unknown $download_name (optional)
	 */
