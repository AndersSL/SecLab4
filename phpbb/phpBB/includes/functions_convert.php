 ...
 *
 * @param int     $pad (optional) Amount to add to the maximum value
...
/**
 *
 * @param unknown $gallery_name         (optional)
 * @param unknown $subdirs_as_galleries (optional)
 */
...
/**
 *
 * @param unknown $category_name (optional)
 */
...
/**
 *
 * @param unknown $config_var
 * @param unknown $source
 * @param unknown $use_target
 * @return unknown
 */
 ...
 *
 * @param unknown $source
 * @param unknown $use_target (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $src
 * @param unknown $func (optional)
 * @param unknown $arg1 (optional)
 * @param unknown $arg2 (optional)
 * @return unknown
 */
 ...
 * @param unknown $user_id
 * @param unknown $group_leader (optional)
 */
 ...
 *
 * @param unknown $path
 * @param unknown $path_relative (optional)
 * @return unknown
 */
 ...
 * @param unknown $src_url
 * @param unknown $test_file
 * @return unknown
 */
 ...
 * @param unknown $prefixes  (reference)
 */
 ...
 * @param int     $setting  (optional) ACL_YES|ACL_NO|ACL_NEVER
 */
 ...
 * @param unknown $convert_size     (optional)
 * @param unknown $extended_bbcodes (optional)
 * @return unknown
 */
 ...
 * @param unknown $die_on_failure       (optional)
 * @param unknown $source_relative_path (optional)
 * @return unknown
 */
 ...
 * @param unknown $src
 * @param unknown $trg
 * @param unknown $copy_subdirs         (optional)
 * @param unknown $overwrite            (optional)
 * @param unknown $die_on_failure       (optional)
 * @param unknown $source_relative_path (optional)
 */
 ...
 *
 * @param unknown $path
 * @param unknown $is_relative (optional)
