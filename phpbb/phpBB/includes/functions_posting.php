 ...
 * @param bool    $return_update_sql (optional) true: SQL query shall be returned, false: execute SQL
 * @return unknown
 */
 ...
 *
 * @param unknown $forum_id
 * @param unknown $cur_topic_type (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $attachment_data (reference)
 * @return unknown
 */
 ...
 *
 * @param unknown $attachment_data
 * @param unknown $filename_data   (reference)
 * @param unknown $show_attach_box (optional)
 * @return unknown
 */
 ...
 * @param unknown $pm_action (optional)
 * @param unknown $msg_id    (optional)
 */
 ...
 * @param unknown $cur_post_id       (optional)
 * @param unknown $show_quote_button (optional)
 * @return unknown
 */
 ...
 * @param unknown $is_soft           (optional)
 * @param unknown $softdelete_reason (optional)
 * @return unknown
 */
 ...
 * @param unknown $topic_type
 * @param unknown $poll_ary            (reference)
 * @param unknown $data_ary            (reference)
 * @param unknown $update_message      (optional)
 * @param unknown $update_search_index (optional)
 * @return unknown
 */
 ...
 * @param int     $bump_time (optional) The time at which topic was bumped, usually it is a current time as obtained via time().
 ...
 *
 * @param unknown $forum_style (optional)
 */
 ...
 * @param array   $post_data     (reference) Array with the post data
 * @param bool    $is_soft       (optional) The flag indicating whether it is the soft delete mode
 * @param string  $delete_reason (optional) Description for the post deletion reason
 * @return null
 */
