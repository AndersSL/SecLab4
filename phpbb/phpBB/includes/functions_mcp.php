 ...
 * @param unknown $read_tracking (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $mode
 * @param unknown $sort_days_val   (reference)
 * @param unknown $sort_key_val    (reference)
 * @param unknown $sort_dir_val    (reference)
 * @param unknown $sort_by_sql_ary (reference)
 * @param unknown $sort_order_sql  (reference)
 * @param unknown $total_val       (reference)
 * @param unknown $forum_id        (optional)
 * @param unknown $topic_id        (optional)
 * @param string  $where_sql       (optional) should either be WHERE (default if ommited) or end with AND or OR
 */
 ...
 * @param mixed       $single_forum (optional) Limit to one forum id (int) or the first forum found (true)
