...
class p_master {
	 ...
	 *
	 * @param unknown $include_path (optional)
	 */
	 ...
	 * @param mixed   $module_mode     (optional) The module mode to check. If provided the mode will be checked in addition for presence.
	 ...
	 * @param bool         $execute_module (optional) If true, at the end we execute the main method for the new instance
	 */
	 ...
	 * @param unknown $left_id
	 * @param unknown $right_id
	 * @param unknown $all_parents (reference)
	 * @return unknown
	 */
	 ...
	 * Not in use
	 *
	 * @param unknown $modules (reference)
	 * @param unknown $parents (reference)
	 * @return unknown
	 */
	 ...
	 * @param string  $mode  (optional) mode, as passed through to the module
	 */
