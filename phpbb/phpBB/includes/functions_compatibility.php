 ...
 * @param unknown $errstr    (reference)
 * @param unknown $errno     (reference)
 ...
 * @param bool    $is_dynamic   (optional) Whether this variable should be cached (false) or
 * @param config  $set_config   (optional)
 * @return null
 */
 ...
 * @param bool                                        $multibyte (optional) If $default is a string this paramater has to be true if the variable may contain any UTF-8 characters
 * @param bool                                        $cookie    (optional) This param is mapped to \phpbb\request\request_interface::COOKIE as the last param for
 ...
 * @param unknown $result    (reference)
 * @param unknown $var
 * @param unknown $type
 ...
 * @param unknown $entry_removed (optional)
 * @return unknown
 */
 ...
 *
 * @deprecated 3.2.0-dev (To be removed: 4.0.0)
 * @param unknown $reason_id (optional)
 */
 ...
 * @param array   $local_filedata (optional) A filespec object created for the local file
 ...
 * @param string  $type (optional) Resource record type to lookup
 ...
 * @param array                  $exclude (optional) A list of variable names that should not be forwarded
