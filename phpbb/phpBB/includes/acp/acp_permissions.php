...
class acp_permissions {
	 ...
	 * @param unknown $default_option
	 * @param unknown $permission_scope
	 * @return unknown
	 */
	 ...
	 * @param unknown $auth_admin
	 * @param unknown $user_id         (reference)
	 ...
	 * @param unknown $auth_settings (reference)
	 * @return unknown
	 */
	 ...
	 * @param unknown $user_id         (reference)
	 * @param unknown $group_id        (reference)
	 * @param unknown $forum_id        (reference)
	 */
