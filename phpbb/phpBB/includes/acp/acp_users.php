...
class acp_users {
	 ...
	 *
	 * @param array   $user_row (reference) Row from the users table.
	 * @param int     $key      Option key, as defined in $user->keyoptions property.
	 * @param bool    $value    True to set the option, false to clear the option.
	 * @param int     $data     (optional) Current bit field value, or false to use $user_row['user_options']
	 ...
	 * @param array   $user_row (reference) Row from the users table.
	 * @param int     $key      option key, as defined in $user->keyoptions property.
	 * @param int     $data     (optional) bit field value to use, or false to use $user_row['user_options']
