...
class acp_styles {
	 ...
	 * Show styles list
	 *
	 * @param array   $styles (reference) styles list
	 ...
	 *
	 * @param array   $styles (reference) Styles list, passed as reference
	 ...
	 * @param int     $id     (optional) id of style
	 * @param int     $parent (optional) current parent style id
	 * @param int     $level  (optional) current tree level
	 ...
	 *
	 * @param array   $style (reference) style row
	 * @param int     $level style inheritance level
	 */
	 ...
	 * Sort styles
	 *
	 * @param unknown $style1
	 * @param unknown $style2
	 * @return unknown
	 */
	 ...
	 * @param string  $dir  (optional) Directory to remove inside style's directory
	 ...
	 * @param bool       $error   (optional) If true, error will be triggered if list is empty
	 * @return array Items
	 */
