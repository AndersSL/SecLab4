...
class auth_admin extends \phpbb\auth\auth
{
	 ...
	 * @param mixed                    $user_id     (optional) user ids to search for (a user_id or a group_id has to be specified at least)
	 * @param mixed                    $group_id    (optional) group ids to search for, return group related settings (a user_id or a group_id has to be specified at least)
	 * @param mixed                    $forum_id    (optional) forum_ids to search for. Defining a forum id also means getting local settings
	 * @param string                   $auth_option (optional) the auth_option defines the permission setting to look for (a_ for example)
	 ...
	 * @param unknown $hold_ary        (reference)
	 * @param unknown $user_mode       (optional)
	 * @param unknown $local           (optional)
	 * @param unknown $group_display   (optional)
	 */
	 ...
	 *
	 * @param unknown $ug_type
	 * @param unknown $forum_id
	 * @param unknown $ug_id
	 * @param unknown $auth
	 * @param unknown $role_id        (optional)
	 * @param unknown $clear_prefetch (optional)
	 */
	 ...
	 *
	 * @param unknown $mode
	 * @param unknown $ug_id           (optional)
	 * @param unknown $forum_id        (optional)
	 * @param unknown $permission_type (optional)
	 */
	 ...
	 *
	 * @param unknown $category_array (reference)
	 * @param unknown $tpl_cat
	 * @param unknown $tpl_mask
	 * @param unknown $ug_id
	 * @param unknown $forum_id
	 * @param unknown $s_view
	 * @param unknown $show_trace     (optional)
	 * @return unknown
	 */
	 ...
	 * used by display_mask()
	 *
	 * @param unknown $permission_row (reference)
	 * @param unknown $content_array  (reference)
	 * @param unknown $categories     (reference)
	 * @param unknown $key_sort_array
	 * @return unknown
	 */
