...
class acp_attachments {
	 ...
	 *
	 * @param unknown $limit (optional) string Additional limit for WHERE clause to filter stats by.
	 ...
	 *
	 * @param unknown $stats array Array of config key => value pairs to set.
	 * @return null
	 */
	 ...
	 *
	 * @param unknown $select_name
	 * @param unknown $default_group (optional)
	 * @param unknown $key           (optional)
	 * @return unknown
	 */
