...
class mcp_queue {
	 ...
	 *
	 * @param unknown $action       string Action we perform on the posts ('approve' or 'restore')
	 * @param unknown $post_id_list array IDs of the posts to approve/restore
	 * @param unknown $id           mixed Category of the current active module
	 * @param unknown $mode         string Active module
	 * @return null
	 */
	 ...
	 *
	 * @param unknown $action        string Action we perform on the posts ('approve' or 'restore')
	 * @param unknown $topic_id_list array IDs of the topics to approve/restore
	 * @param unknown $id            mixed Category of the current active module
	 * @param unknown $mode          string Active module
	 * @return null
	 */
	 ...
	 * Disapprove Post
	 *
	 * @param unknown $post_id_list array IDs of the posts to disapprove/delete
	 * @param unknown $id           mixed Category of the current active module
	 * @param unknown $mode         string Active module
	 * @return null
	 */
