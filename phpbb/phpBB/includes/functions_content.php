 ...
 *
 * @param unknown $limit_days   (reference)
 * @param unknown $sort_by_text (reference)
 * @param unknown $sort_days    (reference)
 * @param unknown $sort_key     (reference)
 * @param unknown $sort_dir     (reference)
 * @param unknown $s_limit_days (reference)
 * @param unknown $s_sort_key   (reference)
 * @param unknown $s_sort_dir   (reference)
 * @param unknown $u_sort_param (reference)
 * @param unknown $def_st       (optional)
 * @param unknown $def_sk       (optional)
 * @param unknown $def_sd       (optional)
 */
 ...
 * @param unknown $select_all    (optional)
 * @param unknown $acl_list      (optional)
 * @param unknown $force_display (optional)
 */
 ...
 * @param unknown $topic_bumped
 * @param unknown $last_post_time
 * @param unknown $topic_poster
 * @param unknown $last_topic_poster
 * @return unknown
 */
 ...
 * @param int     $length (optional) The desired length of the resulting text, however the result might be shorter or longer than this value
 ...
 * @param string  $bbcode_uid (optional) BBCode UID
 * @return null
 */
 ...
 * @param unknown $text
 * @param unknown $uid
 * @param unknown $bitfield
 * @param unknown $flags
 * @param unknown $censor_text (optional)
 * @return unknown
 */
 ...
 *
 *
 * @param string  $text               (reference) The text to be replaced with the parsed one
 * @param string  $uid                (reference) The BBCode uid for this parse
 * @param string  $bitfield           (reference) The BBCode bitfield for this parse
 * @param int     $flags              (reference) The allow_bbcode, allow_urls and allow_smilies compiled into a single integer.
 * @param bool    $allow_bbcode       (optional) If BBCode is allowed (i.e. if BBCode is parsed)
 * @param bool    $allow_urls         (optional) If urls is allowed
 * @param bool    $allow_smilies      (optional) If smilies are allowed
 * @param bool    $allow_img_bbcode   (optional)
 * @param bool    $allow_flash_bbcode (optional)
 * @param bool    $allow_quote_bbcode (optional)
 * @param bool    $allow_url_bbcode   (optional)
 * @param string  $mode               (optional) Mode to parse text as, e.g. post or sig
 ...
 *
 * @param unknown $text
 * @param unknown $server_url (optional)
 ...
 *
 * @param unknown $text
 * @param unknown $force_option (optional)
 * @return unknown
 */
 ...
 * @param bool    $preview           (optional) If set to true the attachments are parsed for preview. Within preview mode the comments are fetched from the given $attachments array and not fetched from the database.
 */
 ...
 * @param int     $max_length       (optional) Maximum length of string (multibyte character count as 1 char / Html entity count as 1 char)
 * @param int     $max_store_length (optional) Maximum character length of string (multibyte character count as 1 char / Html entity count as entity chars).
 * @param bool    $allow_reply      (optional) Allow Re: in front of string
 * @param string  $append           (optional) String to be appended
 * @return unknown
 */
 ...
 * @param string  $username_colour    (optional) The users colour
 * @param string  $guest_username     (optional) optional parameter to specify the guest username. It will be used in favor of the GUEST language variable then.
 * @param string  $custom_profile_url (optional) optional parameter to specify a profile url. The user id get appended to this url as &amp;u={user_id}
...
class bitfield {
	...
	/**
	 *
	 * @param unknown $bitfield (optional)
	 */
 ...
 * @param string                              $message_link         (optional) Link of the original quoted post
 */
