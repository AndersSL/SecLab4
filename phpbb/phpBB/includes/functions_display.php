 ...
 * Display Forums
 *
 * @param unknown $root_data          (optional)
 * @param unknown $display_moderators (optional)
 * @param unknown $return_moderators  (optional)
 * @return unknown
 */
 ...
 *
 * @param unknown $forum_data (reference)
 */
 ...
 *
 * @param unknown $forum_data_ary (reference)
 */
 ...
 *
 * @param unknown $forum_moderators (reference)
 ...
 *
 * @param unknown $topic_row    (reference)
 * @param unknown $replies
 * @param unknown $unread_topic
 * @param unknown $folder_img   (reference)
 * @param unknown $folder_alt   (reference)
 * @param unknown $topic_type   (reference)
 */
 ...
 *
 * @param unknown $userdata_ary (reference)
 */
 ...
 *
 * @param unknown $mode
 * @param unknown $s_watching    (reference)
 * @param unknown $user_id
 * @param unknown $forum_id
 * @param unknown $topic_id
 * @param unknown $notify_status (optional)
 * @param unknown $start         (optional)
 * @param unknown $item_title    (optional)
 */
 ...
 *
 * @param unknown $data
 * @param unknown $user_notes_enabled   (optional)
 * @param unknown $warn_user_enabled    (optional)
 * @param unknown $check_can_receive_pm (optional)
 * @return unknown
 */
