...
class phpbb_text_processing_generate_text_for_storage_test extends phpbb_test_case
{
	 ...
	 * @param unknown $allow_urls
	 * @param unknown $allow_smilies
	 * @param unknown $allow_img_bbcode
	 * @param unknown $allow_flash_bbcode
	 * @param unknown $allow_quote_bbcode
	 * @param unknown $allow_url_bbcode
	 * @param unknown $setup              (optional)
	 */
