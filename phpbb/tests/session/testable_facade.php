...
class phpbb_session_testable_facade {
	 ...
	 *
	 * @param unknown $host
	 * @param unknown $server_name_config
	 * @param unknown $cookie_domain_config
	 * @return unknown
	 */
	 ...
	 * @param unknown             $update_session_page (optional)
	 * @param unknown             $config_overrides    (optional)
	 * @param unknown             $request_overrides   (optional)
	 * @param unknown             $cookies_overrides   (optional)
	 ...
	 * @param array   $config_overrides (optional)
	 * @param unknown $user_agent       (optional)
	 * @param unknown $ip_address       (optional)
	 * @param array   $bot_overrides    (optional)
	 * @param unknown $uri_sid          (optional)
	 * @return unknown
	 */
	...
	/**
	 *
	 * @param unknown $check_script_path
	 * @param unknown $referer
	 * @param unknown $host
	 * @param unknown $force_server_vars
	 * @param unknown $server_port
	 * @param unknown $server_name
	 * @param unknown $root_script_path
	 * @return unknown
	 */
