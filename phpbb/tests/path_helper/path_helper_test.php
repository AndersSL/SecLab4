...
class phpbb_path_helper_test extends phpbb_test_case
{
	 ...
	 * @param unknown $input
	 * @param unknown $getPathInfo
	 * @param unknown $getRequestUri
	 * @param unknown $getScriptName
	 ...
	 * @param unknown $referer_url
	 * @param unknown $board_url
	 * @param unknown $expected
	 */
