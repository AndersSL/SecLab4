...
class phpbb_test_case_helpers {
	 ...
	 *
	 * @param ContainerInterface $container   (optional) Service container
	 * @param string             $fixture     (optional) Path to the XML fixture
	 * @param string             $styles_path (optional) Path to the styles dir
