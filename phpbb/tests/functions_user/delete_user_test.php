...
class phpbb_functions_user_delete_user_test extends phpbb_database_test_case
{
	 ...
	 * @param unknown $mode
	 * @param unknown $retain_username
	 * @param unknown $expected_posts
	 * @param unknown $expected_topics
	 * @param unknown $expected_forums
	 */
	 ...
	 * @param unknown $mode
	 * @param unknown $expected_posts
	 * @param unknown $expected_reports
	 * @param unknown $expected_topics
	 * @param unknown $expected_attach
	 */
	 ...
	 * @param unknown $expected_zebra
	 * @param unknown $expected_ban
	 * @param unknown $expected_sessions
	 * @param unknown $expected_logs
	 * @param unknown $expected_pms
	 */
