...
class phpbb_passwords_manager_test extends \phpbb_test_case
{
	 ...
	 * @param unknown $first_type
	 * @param unknown $second_type
	 * @param unknown $expected    (optional)
	 */
	 ...
	 * @param unknown $use_new_interface
	 * @param unknown $needs_rehash
	 * @param unknown $expected
	 */
