...
class phpbb_textformatter_s9e_bbcode_merger_test extends phpbb_test_case
{
	 ...
	 * @param unknown $usage_without
	 * @param unknown $template_without
	 * @param unknown $usage_with
	 * @param unknown $template_with
	 * @param unknown $expected_usage
	 * @param unknown $expected_template
	 */
